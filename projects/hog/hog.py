...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        gain_score = max_digit+1

    else:
        gain_score = roll_dice(num_rolls,dice)
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        ...
        this_turn_gain_score = 0
        #print("who",who)
        if who == 0:
            num_rolls_play0 = strategy0(score0,score1)
            dice = select_dice(score0,score1)
            this_turn_gain_score = take_turn(num_rolls_play0,score1,dice)
            score0 += this_turn_gain_score

        else:
            num_rolls_play1 = strategy1(score1,score0)
            dice = select_dice(score1,score0)
            this_turn_gain_score = take_turn(num_rolls_play1,score0,dice)
            score1 += this_turn_gain_score

        sumScore = score0 + score1 

        if is_prime(sumScore):
            if score1 > score0:
                score1 += this_turn_gain_score
            elif score1 < score0:
                score0 += this_turn_gain_score
...
def max_scoring_num_rolls(dice=six_sided):
    ...
    """
    "*** YOUR CODE HERE ***"
    averageFun = make_averaged(roll_dice)

    times = 1
    maxAve = -1
    maxtimes = 1
    while times <= 10:
        average = averageFun(times,dice)
        if average >= maxAve :
            maxAve = average
            maxtimes = times
        times+=1
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    """
    "*** YOUR CODE HERE ***"
    gain_score = take_turn(0, opponent_score)

    if gain_score >= margin:
        return 0
...
def prime_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    if is_prime(score+opponent_score+gain_score):
        if score + gain_score > opponent_score:
            return 0
        elif score + gain_score < opponent_score:
            return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score < 30:
        ...
        return prime_strategy(score,opponent_score,margin = 9,num_rolls = 5) 
